		...
		execute $sql$
			...
			updated as (
				...
				set
					audience = d.audience,
					name = d.name,
					price_mwk = d.price_mwk,
					billing_interval = d.billing_interval,
					coins_multiplier = d.coins_multiplier,
					ads_enabled = d.ads_enabled,
					can_participate_battles = d.can_participate_battles,
					battle_priority = d.battle_priority,
					analytics_level = d.analytics_level,
					content_access = d.content_access,
					content_limit_ratio = d.content_limit_ratio,
