...
export default async function DjEarningsDetailPage(props: { params: Promise<{ id: string }> }) {
	...
	const title = (dj as any)?.stage_name || (dj as any)?.name || `DJ ${id}`
	...
	return (
		<div className="space-y-6">
			<div className="flex items-center justify-between">
				...
				<Link
					href="/admin/payments/earnings/djs"
			...
			<div className="rounded-2xl border border-white/10 bg-white/5 p-6">
				...
				<p className="mt-3 text-xs text-gray-500">Use the Freeze/Unfreeze action on the main DJ Earnings page.</p>
			</div>
