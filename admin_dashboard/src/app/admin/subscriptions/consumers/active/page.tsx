...
export default async function AdminSubscriptionsConsumersActivePage() {
	...
	return (
		<div className="space-y-6">
			<div className="flex items-center justify-between">
				<div>
					<h1 className="text-2xl font-bold">Consumers — Active</h1>
					<p className="mt-1 text-sm text-gray-400">Active subscriptions with end date in the future (or no end date).</p>
				</div>
				<Link
						...
						{rows.length ? (
							...
							<tr>
								<td colSpan={7} className="py-6 text-sm text-gray-400">
									No active consumer subscriptions found.
								</td>
							</tr>
						)}
					</tbody>
