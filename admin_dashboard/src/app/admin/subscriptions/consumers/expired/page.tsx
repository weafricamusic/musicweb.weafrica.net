...
export default async function AdminSubscriptionsConsumersExpiredPage() {
	...
	return (
		<div className="space-y-6">
			<div className="flex items-center justify-between">
				<div>
					<h1 className="text-2xl font-bold">Consumers — Expired</h1>
					<p className="mt-1 text-sm text-gray-400">Subscriptions marked expired (usually set by the expiry cron).</p>
				</div>
				<Link
			...
			<div className="grid gap-4 md:grid-cols-3">
				...
				<div className="rounded-2xl border border-white/10 bg-white/5 p-5">
					...
					<div className="mt-1 text-sm text-gray-300">Latest 200 expired</div>
				</div>
			</div>
						...
						{rows.length ? (
							...
							<tr>
								<td colSpan={8} className="py-6 text-sm text-gray-400">
									No expired consumer subscriptions found.
								</td>
							</tr>
						)}
					</tbody>
