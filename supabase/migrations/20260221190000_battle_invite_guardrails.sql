-- Battle invite guardrails (production hardening)
--
-- Adds server-side enforcement for:
-- - Duplicate pending invites (from_uid -> to_uid)
-- - Pending invite cap per sender (default: 3 active pending)
-- - Best-effort auto-expire stale pending invites on create
--
-- Note: The Edge Function also enforces these rules as a UX fast-path.
