                ...
                builder: (context, snap) {
                  ...
                  if (supabaseError != null) {
                    if (kIsWeb) {
                      ...
                      return SupabaseSetupScreen(errorMessage: supabaseError.toString());
                    }
                  }
