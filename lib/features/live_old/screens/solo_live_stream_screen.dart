...
import '../widgets/host_challenge_panel.dart';
        ...
        body: GestureDetector(
          ...
          child: Stack(
            ...
            children: [
              ...
              // Host Challenge Panel - Shows incoming battle requests
              HostChallengePanel(
                liveId: _liveId,
                onChallengeAccepted: () {
                  // Transition to battle mode
                  // This will be handled by navigation or state change
                },
                onChallengeDeclined: () {
                  // Continue solo stream
                },
              ),
