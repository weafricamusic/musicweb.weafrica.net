          ...
          children: [
            ...
            if (_giftPulseText != null)
              Positioned(
                ...
                right: 18,
                bottom: 18,
                child: _GiftNotification(text: _giftPulseText!),
              ),
...
class _StatusTab extends StatelessWidget {
  const _StatusTab({required this.active, required this.label});
...
class _CompetitorStatusRow extends StatelessWidget {
  const _CompetitorStatusRow({
    required this.competitor1Name,
    required this.competitor2Name,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Icon(Icons.info_outlined, color: _ConsumerBattleScreenState._grassGlow, size: 20),
          const SizedBox(width: 10),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
...
class _SupportDeskPanel extends StatelessWidget {
  const _SupportDeskPanel({
...
class _GiftNotification extends StatelessWidget {
  const _GiftNotification({required this.text});
...
class _BattleResultsModal extends StatelessWidget {
  const _BattleResultsModal({
    required this.status,
    required this.competitor1Name,
    required this.competitor2Name,
