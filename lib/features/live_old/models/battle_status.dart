...
class BattleStatus {
  ...
  // Aliases for competitor naming (used by UI)
  String get competitor1Id => hostAId;
  String get competitor2Id => hostBId;
  int get competitor1Score => hostAScore;
  int get competitor2Score => hostBScore;

  // Get top supporter name
  String? get topSupporterName {
    if (topGifters.isEmpty) return null;
    return topGifters.first.senderName;
  }
