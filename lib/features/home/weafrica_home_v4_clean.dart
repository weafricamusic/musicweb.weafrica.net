  ...
  Future<void> _loadData() async {
    try {
      ...
      final top = await supabase
          .from('songs')
          .select('id, title, artist, thumbnail_url, plays_count')
          .order('plays_count', ascending: false)
          .limit(10);
      ...
      final videos = await supabase
          .from('videos')
          .select('id, title, artist, thumbnail_url, views_count, video_url, url, video, videoUrl')
                      ...
                      ClipRRect(
                        ...
                        child: Container(
                          ...
                          child: song['thumbnail_url'] != null
                              ...
                              : const Icon(Icons.music_note, color: Colors.orange, size: 25),
                        ),
                      ),
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: song['thumbnail_url'] == null
                            ? Icon(Icons.music_note, color: Colors.orange, size: 25)
                            : null,
                      ),
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: song['thumbnail_url'] == null ? Icon(Icons.album, size: 20, color: Colors.orange) : null,
                      ),
                      Expanded(
                        child: Padding(
                    ...
                    return Container(
                      ...
                      child: const Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(Icons.play_circle_filled, color: Colors.orange, size: 35),
                            SizedBox(height: 6),
                            Text("No Videos", style: TextStyle(color: Colors.white54, fontSize: 10)),
                          ],
                        ),
                      ),
                    );
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Opening video: ${v.videoUri}')),
                        );
                      ...
                      Stack(
                        children: [
                          Container(
                            ...
                            child: song['thumbnail_url'] == null
                                ? const Icon(Icons.music_note, color: Colors.orange, size: 35)
                                : null,
                          ),
                          Positioned(
                            top: 6,
